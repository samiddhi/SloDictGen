...
DECOR = {
    ...
    'bibl.': {'si': 'biblijsko; prim.', 'en': 'biblical; compare'},
    ...
    'ekspr.': {'si': 'ekspresivno; prim.', 'en': 'expressive; compare'},
    'elektr.': {'si': 'elektrotehnika', 'en': 'electrical engineering'},
    'elipt.': {'si': 'eliptično; prim.', 'en': 'elliptical; compare'},
    'etn.': {'si': 'etnografija, etnologija', 'en': 'ethnography, ethnology'},
    'evfem.': {'si': 'evfemistično; prim.', 'en': 'euphemistic; compare'},
    ...
    'ljubk.': {'si': 'ljubkovalno; prim.', 'en': 'endearing; compare'},
    ...
    "otr.": {"si": "otroško; prim.", "en": "childish; compare"},
    "oz.": {"si": "oziroma", "en": "or"},
